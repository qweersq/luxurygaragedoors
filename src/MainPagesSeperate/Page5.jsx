    ...
    return (
        <div id="service">
            <div className='bg-[#2A2A2A] flex justify-center'>
                <div className='max-w-[1280px] flex grid grid-cols-3 max-md:grid-cols-6 gap-4 flex gap-10 text-white px-32 py-20 max-lg:flex-col max-md:p-10 max-sm:p-10 max-xl:p-20'>
