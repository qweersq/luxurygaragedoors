...
function Page3() {
    ...
    const [knowUsMore, setKnowUsMore] = React.useState(false);

    return (
        <>
            <div id="about">
                <div className='bg-[#2A2A2A] flex flex-col justify-center items-center gap-10 text-white py-20 max-lg:flex-col'>
                    <div className='max-w-[1280px] px-32 flex justify-center items-center max-lg:flex-col max-lg:px-10'>
                        <div className='flex flex-col gap-5'>
                            ...
                            {/* {!knowUsMore && (
                                <button
                                    onClick={() => setKnowUsMore(!knowUsMore)}
                                    className='flex justify-center gap-2 items-center max-w-[220px] h-61 rounded-full bg-[#D74339] bg-opacity-90 px-4 py-2 hover:bg-opacity-50 transition duration-300'>
                    ...
                    {/* {knowUsMore && (
                        <button
                            onClick={() => setKnowUsMore(!knowUsMore)}
                            className='flex justify-center gap-2 items-center max-w-[220px] h-61 rounded-full bg-[#D74339] bg-opacity-90 px-4 py-2 hover:bg-opacity-50 transition duration-300'>
                            <p className='text-white font-medium'>Show Less</p>
                            <FaCircleArrowRight className='text-white' />
                        </button>
                    )} */}
                </div>
